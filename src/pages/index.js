...
const IndexPage = () => (
  <Layout>
    ...
    <section id="why" className="py-40">
      <div className="w-9/12 mx-auto text-center">
        <h2 className="text-3xl lg:text-5xl font-semibold">Bagaimana dengan JAMStack</h2>
    ...
    <section id="konsep" className="py-36">
    ...
    <section id="blog" className="section-blog px-16 py-32">
      <div className="container mx-auto">
